  ...
  return (
    <div className="space-y-10">
        ...
        <div className="grid lg:grid-cols-2">
          ...
          <div className="p-6 sm:p-8 space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-3 pt-2">
              ...
              <div className="rounded-xl border p-4">
                <div className="text-xs text-muted-foreground">Disponível para</div>
            ...
            <div className="rounded-xl border p-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                reach out. I’m open to internships, junior roles, freelance and
                collaborations.
              </p>
            </div>
          </div>
          ...
          {/* Imagem */}
          <div className="relative min-h-[260px] lg:min-h-full bg-muted">
            {/* Se não colocar a imagem, não quebra; só vai aparecer o fundo */}
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-tr from-background/75 via-background/25 to-transparent" />
      ...
      <section className="rounded-xl border p-5 space-y-3">
        ...
        <div className="flex flex-wrap gap-3">
          <a className="rounded-md border px-4 py-2 hover:bg-muted transition" href={CONTACT.github} target="_blank" rel="noreferrer">
            GitHub
          </a>
          <a className="rounded-md border px-4 py-2 hover:bg-muted transition" href={CONTACT.linkedin} target="_blank" rel="noreferrer">
            LinkedIn
          </a>
          <a className="rounded-md border px-4 py-2 hover:bg-muted transition" href={`mailto:${CONTACT.email}`}>
            E-mail
          </a>
        </div>
      </section>
